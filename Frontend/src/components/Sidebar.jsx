import { ShoppingCart, BookOpen, ChefHat, LogOut } from 'lucide-react'
...
export default function Sidebar({ modulo, onModulo, user, onLogout }) {
  return (
    <aside className="w-60 bg-amber-950 flex flex-col h-screen flex-shrink-0 select-none">
      {/* Brand */}
      <div className="flex items-center gap-3 px-5 py-6 border-b border-amber-900/60">
      ...
      {/* Navigation */}
      <nav className="flex-1 px-3 py-5 space-y-1" aria-label="Módulos">
